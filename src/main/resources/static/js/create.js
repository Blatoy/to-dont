...
function addUser() {
    ...
    tr.innerHTML = '<td><label><input class="uk-checkbox" type="checkbox" name="moderatorBoolean[]" value="1">\
                    <input type="hidden" name="moderatorBoolean[]" value="0"> Moderator</label></td>\
